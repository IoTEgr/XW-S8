...
MENU_OPTION_START(printnearfar)		//----print mode
MENU_OPTION_STR(R_ID_STR_TIP_NEAR)
MENU_OPTION_STR(R_ID_STR_TIP_MIDDLE)
MENU_OPTION_STR(R_ID_STR_TIP_FAR)
MENU_OPTION_END()
...
MENU_ITEM_OPTIONS(printnearfar,CONFIG_ID_PRINTER_NEARFAR,R_ID_ICON_MENUPRINTDENSITY,R_ID_STR_TIP_NEAR)
