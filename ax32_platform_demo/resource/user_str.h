...
enum
{
   ...
   R_ID_STR_APP_TIPS4,
   R_ID_STR_CAP_PRINT,
   R_ID_STR_TIPS_TAKEING_PHOTO,
   R_ID_STR_TIP_KEEPQ,
   R_ID_STR_TIP_PLZ_CHARG,
   R_ID_STR_TIP_PIC_ERR,
   R_ID_STR_TIP_NO_SPACE,
   R_ID_STR_TIP_NEAR,
   R_ID_STR_TIP_MIDDLE,
   R_ID_STR_TIP_FAR,
   R_ID_STR_TIP_KEEPQ_PLZ_CHARG,
   R_STR_MAX
};
