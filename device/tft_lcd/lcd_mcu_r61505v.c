...
CMD(0x00),CMD(0x07),DAT(0x00),DAT(0x72), 
{DELAY_MS,100},

CMD(0x00),CMD(0x07),DAT(0x00),DAT(0x01), 
{DELAY_MS,10},

CMD(0x00),CMD(0x07),DAT(0x00),DAT(0x00),
CMD(0x00),CMD(0x10),DAT(0x06),DAT(0x80),
CMD(0x00),CMD(0x11),DAT(0x00),DAT(0x64),
CMD(0x00),CMD(0x12),DAT(0x01),DAT(0x29),
{DELAY_MS,50},
CMD(0x00),CMD(0x10),DAT(0x06),DAT(0x00),
CMD(0x00),CMD(0x10),DAT(0x06),DAT(0x02),


//*************Power On sequence ******************//
CMD(0x00),CMD(0x10),DAT(0x00),DAT(0x00), // SAP, BT[3:0], AP, DSTB, SLP
CMD(0x17),DAT(0x00),DAT(0x01),
{DELAY_MS,10},

CMD(0x10),DAT(0x13),DAT(0xb0),
CMD(0x11),DAT(0x00),DAT(0x07),
CMD(0x12),DAT(0x01),DAT(0x1a),
CMD(0x13),DAT(0x14),DAT(0x00),
CMD(0x29),DAT(0x00),DAT(0x07),

CMD(0x12),DAT(0x01),DAT(0x3a),
{DELAY_MS,120},
...
CMD(0x07),DAT(0x00),DAT(0x61),
{DELAY_MS,10},

CMD(0x07),DAT(0x01),DAT(0x73),
{DELAY_MS,10},

//------------------ Set GRAM area ---------------//
CMD(0x00),CMD(0x50),CMD(0x00),CMD(0x00), // Horizontal GRAM Start Address
CMD(0x00),CMD(0x51),CMD(0x00),CMD(0xEF), // Horizontal GRAM End Address
CMD(0x00),CMD(0x52),CMD(0x00),CMD(0x00), // Vertical GRAM Start Address
CMD(0x00),CMD(0x53),CMD(0x01),CMD(0x3F), // Vertical GRAM Start Address
//------------------ Set GRAM area ---------------//
CMD(0x00),CMD(0x20),CMD(0x00),CMD(0x00), // Horizontal GRAM Start Address
CMD(0x00),CMD(0x21),CMD(0x00),CMD(0x00), // Vertical GRAM Start Address
CMD(0x00),CMD(0x22),
...
CMD(0x00),CMD(0x00),CMD(0x00),CMD(0x00),
CMD(0x00),CMD(0x00),CMD(0x00),CMD(0x00),
CMD(0x00),CMD(0xA4),DAT(0x00),DAT(0x01),
{DELAY_MS,20},

CMD(0x00),CMD(0x60),DAT(0x27),DAT(0x00),
CMD(0x00),CMD(0x90),DAT(0x00),DAT(0x14),
CMD(0x00),CMD(0x08),DAT(0x04),DAT(0x04),
CMD(0x00),CMD(0x30),DAT(0x11),DAT(0x00),
CMD(0x00),CMD(0x31),DAT(0x67),DAT(0x11),
CMD(0x00),CMD(0x32),DAT(0x06),DAT(0x03),
CMD(0x00),CMD(0x33),DAT(0x18),DAT(0x03),
CMD(0x00),CMD(0x34),DAT(0x00),DAT(0x00),
CMD(0x00),CMD(0x35),DAT(0x03),DAT(0x18),
CMD(0x00),CMD(0x36),DAT(0x63),DAT(0x06),
CMD(0x00),CMD(0x37),DAT(0x11),DAT(0x07),
CMD(0x00),CMD(0x38),DAT(0x00),DAT(0x11),
CMD(0x00),CMD(0x39),DAT(0x00),DAT(0x00),
CMD(0x00),CMD(0x0A),DAT(0x00),DAT(0x08),
CMD(0x00),CMD(0x10),DAT(0x07),DAT(0x30),
CMD(0x00),CMD(0x11),DAT(0x02),DAT(0x37),
CMD(0x00),CMD(0x12),DAT(0x01),DAT(0x98),
CMD(0x00),CMD(0x0E),DAT(0x00),DAT(0x20),
CMD(0x00),CMD(0x13),DAT(0x08),DAT(0x00),
CMD(0x00),CMD(0x2A),DAT(0x00),DAT(0x2c),
CMD(0x00),CMD(0x12),DAT(0x01),DAT(0xBd),
{DELAY_MS,20},
CMD(0x00),CMD(0x50),DAT(0x00),DAT(0x00),
CMD(0x00),CMD(0x51),DAT(0x00),DAT(0xEf),
CMD(0x00),CMD(0x52),DAT(0x00),DAT(0x00),
CMD(0x00),CMD(0x53),DAT(0x01),DAT(0x3F),
CMD(0x00),CMD(0x61),DAT(0x00),DAT(0x01),
CMD(0x00),CMD(0x80),DAT(0x00),DAT(0x00),
CMD(0x00),CMD(0x81),DAT(0x00),DAT(0x00),
CMD(0x00),CMD(0x82),DAT(0x00),DAT(0x00),
CMD(0x00),CMD(0x6A),DAT(0x00),DAT(0x00),
CMD(0x00),CMD(0x92),DAT(0x06),DAT(0x00),
CMD(0x00),CMD(0x93),DAT(0x04),DAT(0x02),
CMD(0x00),CMD(0x01),DAT(0x01),DAT(0x00),
CMD(0x00),CMD(0x02),DAT(0x07),DAT(0x00),
CMD(0x00),CMD(0x03),DAT(0x10),DAT(0x30),
CMD(0x00),CMD(0x20),DAT(0x00),DAT(0x00),
CMD(0x00),CMD(0x21),DAT(0x00),DAT(0x00),
CMD(0x00),CMD(0x07),DAT(0x01),DAT(0x00),
{DELAY_MS,20},
CMD(0x00),CMD(0x22),
...
//进睡眠
 CMD(0x00),CMD(0x07), DAT(0x00),DAT(0x00),
 {DELAY_MS,10},
 CMD(0x00),CMD(0x12), DAT(0x01),DAT(0x80),
 {DELAY_MS,80},

//退出睡眠
 CMD(0x00),CMD(0x12),DAT(0x11),DAT(0xBA),
{DELAY_MS,120},
 CMD(0x00),CMD(0x07),DAT(0x01),DAT(0x00),
{DELAY_MS,40},


CMD(0x00),CMD(0x00),//Initial Sync don't remove
CMD(0x00),CMD(0x00),
{DELAY_MS,10},
CMD(0x00),CMD(0x00),//Initial Sync don't remove
CMD(0x00),CMD(0x00),
...
CMD(0x00),CMD(0x30),DAT(0x01),DAT(0x03),//gamma
CMD(0x00),CMD(0x31),DAT(0x58),DAT(0x0C),
CMD(0x00),CMD(0x32),DAT(0x09),DAT(0x06),
CMD(0x00),CMD(0x33),DAT(0x05),DAT(0x02),
CMD(0x00),CMD(0x34),DAT(0x32),DAT(0x10),
CMD(0x00),CMD(0x35),DAT(0x02),DAT(0x05),
CMD(0x00),CMD(0x36),DAT(0x56),DAT(0x09),
CMD(0x00),CMD(0x37),DAT(0x0C),DAT(0x08),
CMD(0x00),CMD(0x38),DAT(0x03),DAT(0x01),
CMD(0x00),CMD(0x39),DAT(0x10),DAT(0x32),

CMD(0x00),CMD(0x90),DAT(0x00),DAT(0x18),//80Hz
CMD(0x00),CMD(0x10),DAT(0x07),DAT(0x30),//BT,AP
CMD(0x00),CMD(0x11),DAT(0x02),DAT(0x47),//DC1,DC0,VC
CMD(0x00),CMD(0x12),DAT(0x01),DAT(0xBC),
CMD(0x00),CMD(0x13),DAT(0x15),DAT(0x00),
{DELAY_MS,200},

CMD(0x00),CMD(0x01),DAT(0x01),DAT(0x00),
CMD(0x00),CMD(0x02),DAT(0x02),DAT(0x00),
CMD(0x00),CMD(0x03),DAT(0x10),DAT(0x30),
CMD(0x00),CMD(0x09),DAT(0x00),DAT(0x01),
CMD(0x00),CMD(0x0A),DAT(0x00),DAT(0x08),
CMD(0x00),CMD(0x0C),DAT(0x00),DAT(0x00),
CMD(0x00),CMD(0x0D),DAT(0x00),DAT(0x00),
CMD(0x00),CMD(0x0E),DAT(0x00),DAT(0x30),
CMD(0x00),CMD(0x20),DAT(0x00),DAT(0x00),//H Start
CMD(0x00),CMD(0x21),DAT(0x00),DAT(0x00),//V Start
CMD(0x00),CMD(0x29),DAT(0x00),DAT(0x57),
CMD(0x00),CMD(0x50),DAT(0x00),DAT(0x00),
CMD(0x00),CMD(0x51),DAT(0x00),DAT(0xEF),
CMD(0x00),CMD(0x52),DAT(0x00),DAT(0x00),
CMD(0x00),CMD(0x53),DAT(0x01),DAT(0x3F),
CMD(0x00),CMD(0x61),DAT(0x00),DAT(0x00),
CMD(0x00),CMD(0x6A),DAT(0x00),DAT(0x00),
CMD(0x00),CMD(0x80),DAT(0x00),DAT(0x00),
CMD(0x00),CMD(0x81),DAT(0x00),DAT(0x00),
CMD(0x00),CMD(0x82),DAT(0x00),DAT(0x5F),
CMD(0x00),CMD(0x93),DAT(0x05),DAT(0x07),

CMD(0x00),CMD(0x07),DAT(0x01),DAT(0x00),//DISPLAY ON
{DELAY_MS,50},
CMD(0x00),CMD(0x22),//GRAM Data Write
...
LCD_OP_SECTION lcddev_t r61505v = 
{
    .name = "R61505V",
